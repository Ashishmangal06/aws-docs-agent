...
# --------------------------------------------------------------------------- #
# Helper: extract service name from AWS docs URL
# --------------------------------------------------------------------------- #
...
# --------------------------------------------------------------------------- #
# Handle pending message from sidebar sample questions
# --------------------------------------------------------------------------- #
...
# Build the prompt prefix if a service filter is active
service_prefix = ""
...
# Allow sidebar sample question to inject input
...
if user_input:
    ...
    st.session_state.messages.append({
        "role": "user",
        "content": user_input,  # show without prefix in UI
        "citations": [],
    })
